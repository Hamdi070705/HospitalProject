...
@section('content')
    <div class="bg-white p-10 rounded-3xl shadow-lg flex-1 ml-64 min-w-full" style="transform: translateX(125px)">
        ...
        <section class="mb-8">
            <div class="overflow-x-auto overflow-x-auto relative shadow-md sm:rounded-lg">
                <div class="max-h-[400px] overflow-y-auto">
                    <table class="min-w-full bg-white border rounded-lg shadow-sm w-custom  ">
                        <thead class="bg-gray-100 text-txt text-sm sticky top-0 z-50">
                            <tr>
                                    ...
                                    <td class="py-3 px-6">
                                        <div class="flex flex-col sm:flex-row gap-2 justify-center items-center">
                                            <button
                                                ...
                                                onclick="editUser({{ $patient->id }}, '{{ $patient->name }}', '{{ $patient->email }}', '{{ $patient->role }}')">
            ...
            <form id="userForm" method="POST" action="{{ route('users.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="role" id="role" class="w-full border rounded-lg p-2">
                        ...
                        <option value="pasien">dokter</option>
                    </select>
                </div>
